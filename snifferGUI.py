...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.filterBeforeCapture = QtWidgets.QLineEdit(self.centralwidget)
        self.filterBeforeCapture.setGeometry(QtCore.QRect(820, 40, 471, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.filterBeforeCapture.setFont(font)
        self.filterBeforeCapture.setObjectName("filterBeforeCapture")
        self.filterAfterCapture = QtWidgets.QLineEdit(self.centralwidget)
        self.filterAfterCapture.setGeometry(QtCore.QRect(820, 95, 471, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.filterAfterCapture.setFont(font)
        self.filterAfterCapture.setObjectName("filterAfterCapture")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.filterBeforeCapture.setText(_translate("MainWindow", "Ethernet"))
        self.filterAfterCapture.setText(_translate("MainWindow", "Ethernet"))
