...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.refreshButton.setGeometry(QtCore.QRect(360, 90, 150, 50))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.refreshButton.setFont(font)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("static/refresh.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.refreshButton.setText(_translate("MainWindow", "取消过滤"))
